        ...
        <div class="row">
          <div class="card mb-0" style="border-radius: 25px; padding:15px 15px 15px 15px;">
            <div class="card-body">
              ...
              <?php echo "<img src='img/$row[gambar_materi]' class='rounded mx-auto d-block' />";?><br>
              <div class="container-fluid">
                <div class="row">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                  <a href="materi.php?detail=<?php echo $row['id_materi']?>" class="btn btn-sm btn-outline-primary" style="background-color: #1D5D9B; color: white; border: none; width: 195px; height: 40px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">Kembali</a>
                </div>
              </div>
            </div>
          </div>
