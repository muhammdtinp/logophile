  ...
  <div class="content-wrapper">
    ...
    <div class="content" style="padding: 0px 20px 20px 20px;">
      <div class="card mb-0" style="border-radius: 25px; padding:15px 15px 15px 15px;">
        <div class="card-body">
          <h4 style="color: #1D5D9B; padding-bottom:10px;">Tentang Session 1</h4>
          <div class="container-fluid">
            <div class="row">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card-body" style="padding: 0px;">
                        ...
                        Tentang Materi <?php echo $row['judul']?>
                        </h5>
              ...
              <div class="card card-success" style="background-color: #CAF4FF; border-radius: 25px;">
                <div class="card-body" style="padding: 20px; display: flex; justify-content: center; align-items: center;">
                  <div class="row">
                    <div class="col-12">
                      <div class="card-body" style="padding: 0px;">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/<?php echo $row['link_youtube']?>"
              ...
              <h4 style="color: #1D5D9B; padding-bottom:10px;">Media Pembelajaran</h4>
              <div class="card card-success" style="background-color: #CAF4FF; border-radius: 25px;">
                <div class="card-body">
                  <div class="row">
                    <div class="col-12">
                      <div class="card-body" style="padding: 0px;">
                        <div style="display: flex; justify-content: space-between; padding: 5px;">
                            <span style="text-align: left;">Materi Singkat</span>
                            <a href="detail-materi.php?detail=<?php echo $row['id_materi']?>" class="btn btn-sm btn-outline-primary">Lihat Materi</a>
                        </div>
                        <div style="display: flex; justify-content: space-between; padding: 5px;">
                            <span style="text-align: left;">Modul</span>
                            <a href="detail-modul.php?detail=<?php echo $row['id_materi']?>" class="btn btn-sm btn-outline-primary">Lihat Modul</a>
                        </div>
                      </div>
                    </div>
                  </div>
