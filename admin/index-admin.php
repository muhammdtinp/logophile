        ...
        <div class="card-body">
          <div class="container-fluid">
            <div class="row">
              <div class="col-6">
                <div class="card-body">
                  <h5 class="card-title font-weight-bold">Capaian Pembelajaran Fase F TKJ</h5>
                  <p class="card-text text-justify">Pada akhir fase F (kelas XI dan XII SMK), 
                    peserta didik akan mampu merencanakan topologi dan arsitektur
                    jaringan, melakukan pengalamatan jaringan, menginstalasi dan
                      melakukan perbaikan jaringan kabel dan nirkabel, menerapkan 
                      keamanan jaringan, mengkonfigurasi dan memasang perangkat jaringan 
                      ke dalam sistem jaringan, dan mengkonfigurasi server untuk memenuhi 
                      layanan jaringan.</p>
                  </div>
              </div>
              <div class="col-6">
                <div class="card-body">
                <h5 class="card-title font-weight-bold">Elemen Perencanaan Dan Pengalamatan Jaringan</h5>
                <p class="card-text text-justify">Pada akhir fase F, peserta didik mampu merencanakan 
                  topologi dan arsitektur jaringan sesuai kebutuhan, mengumpulkan kebutuhan
                  teknis pengguna yang menggunakan jaringan, mengumpulkan data peralatan
                    jaringan dengan teknologi yang sesuai, melakukan pengalamatan jaringan,
                    memahami CIDR dan VLSM, dan menghitung subnetting.</p>
              </div>
            </div>
            <div class="col-6 ">
              <div class="small-box" style="background-color: #00A9FF;">
                <div class="inner">
                  <h3 style="color: white;"> Materi</h3>
                </div>
                <div class="icon">
                  <i class="fas fa-book"></i>
                </div>
                <a href="materi.php" class="small-box-footer">
            ...
            <div class="col-6 ">
             <div class="small-box" style="background-color: #00A9FF;">
                <div class="inner">
                  <h3 style="color: white;"> Kuis</h3>
                </div>
                <div class="icon">
                  <i class="nav-icon far fa-file"></i>
                </div>
                <a href="kuis.php" class="small-box-footer">
                  Lihat lebih lanjut 
            ...
            <div class="col-6 ">
              <div class="small-box" style="background-color: #00A9FF;">
                ...
                <a href="data-siswa.php" class="small-box-footer">
                  Lihat lebih lanjut <i class="fas fa-arrow-circle-right"></i>
                </a>
              </div>
            </div>
            <div class="col-6 ">
              <div class="small-box" style="background-color: #00A9FF;">
                <div class="inner">
                  <h3 style="color: white;"> Data Laporan</h3>
                </div>
                <div class="icon">
                  <i class="nav-icon fas fa-print"></i>
                </div>
                <a href="data-laporan.php" class="small-box-footer">
                  Lihat lebih lanjut <i class="fas fa-arrow-circle-right"></i>
                </a>
              </div>
            </div>
            <div class="col-6 ">
              <div class="small-box" style="background-color: #00A9FF;">
                <div class="inner">
                  <h3 style="color: white;"> Rekap Nilai Siswa</h3>
                </div>
                <div class="icon">
                  <i class="nav-icon fas fa-clipboard"></i>
                </div>
                <a href="data-nilai.php" class="small-box-footer">
                  Lihat lebih lanjut <i class="fas fa-arrow-circle-right"></i>
                </a>
              </div>
            </div>
            <div class="col-6 ">
              <div class="small-box" style="background-color: #00A9FF;">
                ...
                <a href="forum.php" class="small-box-footer">
                  Lihat lebih lanjut <i class="fas fa-arrow-circle-right"></i>
                </a>
              </div>
            </div>
