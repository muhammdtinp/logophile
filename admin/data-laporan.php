            ...
            <div class="row">
              <table class="table">
                ...
                <tr>
                  ...
                  <td>
                  <a href="detail-laporan.php?detail=<?php echo $row['id_laporan']?>" class="btn btn-sm btn-outline-primary">Lihat File</a>
                  </td>
                  <td>
                  <a href="hapus-laporan.php?hapus=<?php echo $row['id_laporan']?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">Hapus</a>
                  </td>
                </tr>
                <?php
                    }
