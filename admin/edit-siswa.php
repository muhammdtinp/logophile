        ...
        <div class="card-body">
          <div class="container-fluid">
            <div class="row">
              ...
              <input class="form-control" type="hidden" id="id_siswa" name="id_siswa" value="<?php echo $result['id_siswa']?>"><br>
              <label for="nama" class="form-label">Nama Siswa :</label><br>
              <input class="form-control" type="text" id="nama" name="nama" value="<?php echo $result['nama']?>" required><br>
              <label for="email" class="form-label">Email Siswa :</label><br>
              <input class="form-control" type="email" id="email" name="email" value="<?php echo $result['email']?>" required><br>
              <label for="username" class="form-label">Username Siswa :</label><br>
              <input class="form-control" type="text" id="username" name="username" value="<?php echo $result['username']?>" required><br>
              <label for="password" class="form-label">Password Siswa :</label><br>
              <input class="form-control" type="password" id="password" name="password" value="<?php echo $result['password']?>" required><br>
              <label for="nis" class="form-label">NIS :</label><br>
              <input class="form-control" type="text" id="nis" name="nis" value="<?php echo $result['nis']?>" required><br>
              <label for="gender" class="form-label">Gender :</label><br>
              <input type="radio" name="gender" value="Laki-Laki" <?php if($result['gender']=='Laki-Laki') echo 'checked'?> required> Laki-laki
              <input type="radio" name="gender" value="Perempuan" <?php if($result['gender']=='Perempuan') echo 'checked'?> required> Perempuan<br>
              <label for="alamat">Alamat Siswa :</label>
              <textarea class="form-control" id="alamat" name="alamat" style="height: 100px"><?php echo $result['alamat']?></textarea>
              <label for="no_hp" class="form-label">No HP :</label><br>
              <input class="form-control" type="text" id="no_hp" name="no_hp" value="<?php echo $result['no_hp']?>" required><br>
              <button value="Edit Siswa" name="edit_siswa" type="submit" class="btn btn-primary" style="background-color: #1D5D9B; color: white; border: none; width: 195px; height: 40px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">
              Edit Siswa
              </button>
              </form>
            </div>
