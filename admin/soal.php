          ...
          <div class="container-fluid">
            <div class="row">
              <div class="d-grid gap-2 d-md-flex justify-content-md-end" style="padding-bottom: 15px; padding-right: 0px;">
                <a href="tambah-soal.php" class="btn btn-sm btn-outline-primary" style="background-color: #1D5D9B; color: white; border: none; width: 195px; height: 40px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">Tambah</a>
              </div>
              <br>
              <table class="table table-bordered" id='table' style="width: 100%; table-layout: fixed; word-wrap: break-word;">
                <thead>
                  <tr>
                    <th>No</th>
                    <th>Soal</th>
                ...
                <tbody>
                  ...
                  $id_soal = $_GET['id'];
                  $no = 1;
                  $data = mysqli_query($conn, "SELECT * from kuis WHERE id_kategori='$id_soal'");
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="edit-soal.php?id_edit=<?php echo $row['id']?>" class="btn btn-sm btn-outline-success" >Edit</a>
                    <a href="hapus-soal.php?id=<?php echo $row['id']?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">Delete</a>
