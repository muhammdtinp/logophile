    ...
    <div class="content" style="padding: 0px 20px 20px 20px;">
      <div class="card mb-0" style="border-radius: 25px; padding:15px 15px 15px 15px;">
        <div class="card-body" style="overflow-x: auto;">
          <div class="container-fluid">
            <div class="row">
              <form action="proses-tambah-soal.php" method="post"><br>
              <label for="pertanyaan" class="form-label">Pertanyaan :</label><br>
              <input class="form-control" type="text" id="pertanyaan" name="pertanyaan" required><br>
              <label for="option_a" class="form-label">Opsi A :</label><br>
              <input class="form-control" type="text" id="option_a" name="option_a" required><br>
              <label for="option_b" class="form-label">Opsi B :</label><br>
              <input class="form-control" type="text" id="option_b" name="option_b" required><br>
              <label for="option_c" class="form-label">Opsi C :</label><br>
              <input class="form-control" type="text" id="option_c" name="option_c" required><br>
              <label for="option_b" class="form-label">Opsi D :</label><br>
              <input class="form-control" type="text" id="option_d" name="option_d" required><br>
              <label for="option_e" class="form-label">Opsi E :</label><br>
              <input class="form-control" type="text" id="option_e" name="option_e" required><br>
              <label for="jawaban" class="form-label">Jawaban :</label><br>
              <input class="form-control" type="text" id="jawaban" name="jawaban" required><br>
              ...
              <button value="Tambah Soal" name="tambah_soal" type="submit" class="btn btn-primary" style="background-color: #1D5D9B; color: white; border: none; width: 195px; height: 40px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">
                Tambah Soal
              </button><br><br>
              </form>
            </div>
