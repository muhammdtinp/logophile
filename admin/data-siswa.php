    ...
    <div class="content" style="padding: 0px 20px 20px 20px;">
      <div class="card mb-0" style="border-radius: 25px; padding:15px 15px 15px 15px;">
        <div class="card-body">
          <div class="container-fluid">
            <div class="row">
              <div class="d-grid gap-2 d-md-flex justify-content-md-end" style="padding-bottom: 15px; padding-right: 0;">
                <a href="tambah-siswa.php" class="btn btn-sm btn-outline-primary" style="background-color: #1D5D9B; color: white; border: none; width: 195px; height: 40px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">Tambah</a>
              </div><br>
              <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="edit-siswa.php?edit=<?php echo $row['id_siswa']?>" class="btn btn-sm btn-outline-success">Edit</a>
                    <a href="hapus-siswa.php?hapus=<?php echo $row['id_siswa']?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">Hapus</a>
