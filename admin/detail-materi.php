        ...
        <div class="container-fluid">
          <div class="row">
            <div class="card-body">
              ...
              ?>
              <p class="text-center fs-1"><?php echo $row['judul']?></p>
              <?php echo "<img src='../img/$row[gambar_materi]' class='rounded mx-auto d-block img-thumbnail' />";?><br>
              <div class="container-fluid">
                <div class="row"> 
                  <p class="text-center">Sumber : <?php echo $row['sumber_gambar']?></p>
                  <p class="text-justify lh-base" style="text-indent: 45px;"><?php echo $row['pembuka']?></br></p>
                  <p class="text-justify lh-base" style="text-indent: 45px;"><?php echo $row['isi']?></br></p>
                  <p class="text-justify lh-base" style="text-indent: 45px;"><?php echo $row['penutup']?></p>
                  <p class="text-center"><?php echo $row['keterangan']?></p>
                  <p class="text-center"><small class="text-muted"><?php echo $row['nama']?></small></p>
                </div>
              </div>
            </div>
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
              <a href="materi.php" class="btn btn-sm btn-outline-primary" style="background-color: #1D5D9B; color: white; border: none; width: 195px; height: 40px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">Kembali</a>
            </div>
          </div>
        </div>
      </div>
