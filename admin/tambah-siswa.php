    ...
    <div class="content" style="padding: 0px 20px 20px 20px;">
      <div class="card mb-0" style="border-radius: 25px; padding:15px 15px 15px 15px;">
        <div class="card-body">
          <div class="container-fluid">
            <div class="row">
              <form action="proses-tambah-siswa.php" method="post"><br>
              ...
              <input class="form-control" type="text" id="nis" name="nis" required><br>
              <label for="gender" class="form-label">Gender :</label><br>
              <input type="radio" name="gender" value="Laki-laki" required> Laki-laki
              <input type="radio" name="gender" value="Perempuan" required> Perempuan
              <br>
              <label for="alamat">Alamat Siswa :</label>
              <textarea class="form-control" id="alamat" name="alamat" style="height: 100px"></textarea><br>
              <label for="no_hp" class="form-label">No HP :</label><br>
              <input class="form-control" type="text" id="no_hp" name="no_hp" required><br>
              <button value="Tambah Siswa" name="tambah_siswa" type="submit" class="btn btn-primary" style="background-color: #1D5D9B; color: white; border: none; width: 195px; height: 40px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">
              Tambah Siswa
              </button><br>
            </form>
          </div>
