          ...
          <div class="container-fluid">
            <div class="row">
              <div class="d-grid gap-2 d-md-flex justify-content-md-end" style="padding-bottom: 15px; padding-right: 0px;">
                <a href="tambah-kategori.php" class="btn btn-sm btn-outline-primary" style="background-color: #1D5D9B; color: white; border: none; width: 195px; height: 40px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">Tambah Kategori</a>
              </div>
              <table class="table table-bordered" id='table'>
                ...
                <tbody>
                  <?php
                  $no = 1;
                  $data = mysqli_query($conn, "SELECT * from kategori_kuis INNER JOIN guru WHERE kategori_kuis.id_guru = guru.id_guru");
                  ...
                  <tr>
                    ...
                    <td>
                    <center>
                    <a href="soal.php?id=<?php echo $row['id_kategori']?>" class="btn btn-sm btn-outline-primary">Soal</a>
                    <a href="edit-kategori.php?id_edit=<?php echo $row['id_kategori']?>" class="btn btn-sm btn-outline-success">Edit</a>
                    <a href="hapus-kategori.php?id_hapus=<?php echo $row['id_kategori']?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Apakah anda yakin akan menghapus data ini?')">Hapus</a>  
                  </center>
                    </td>
                  </tr>
                  <?php
