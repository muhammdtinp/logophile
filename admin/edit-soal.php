          ...
          <div class="container-fluid">
            <div class="row">
              <?php
                ...
                $sql = "SELECT * FROM kuis m INNER JOIN kategori_kuis k ON m.id_kategori = k.id_kategori WHERE m.id = $id_soal";
              ...
              ?>
              <form action="proses-edit-soal.php" method="post"><br>
                <input type="hidden" name="id" value="<?php echo $row['id']?>">
                <label for="pertanyaan" class="form-label">Pertanyaan :</label><br>
                <input class="form-control" type="text" id="pertanyaan" name="pertanyaan" value="<?php echo $row['question']?>" required><br>
                <label for="option_a" class="form-label">Opsi A :</label><br>
                <input class="form-control" type="text" id="option_a" name="option_a" value="<?php echo $row['option_a']?>" required><br>
                <label for="option_b" class="form-label">Opsi B :</label><br>
                <input class="form-control" type="text" id="option_b" name="option_b" value="<?php echo $row['option_b']?>" required><br>
                <label for="option_c" class="form-label">Opsi C :</label><br>
                <input class="form-control" type="text" id="option_c" name="option_c" value="<?php echo $row['option_c']?>" required><br>
                <label for="option_d" class="form-label">Opsi D :</label><br>
                <input class="form-control" type="text" id="option_d" name="option_d" value="<?php echo $row['option_d']?>" required><br>
                <label for="option_e" class="form-label">Opsi E :</label><br>
                <input class="form-control" type="text" id="option_e" name="option_e" value="<?php echo $row['option_e']?>" required><br>
                <label for="jawaban" class="form-label">Jawaban :</label><br>
                <input class="form-control" type="text" id="jawaban" name="jawaban" value="<?php echo $row['correct_option']?>" required><br>
                ...
                if ($result->num_rows > 0) {
                    while($kategori_row = $result->fetch_assoc()) {
                ...
                <button value="Update Soal" name="update_soal" type="submit" class="btn btn-primary" style="background-color: #1D5D9B; color: white; border: none; width: 195px; height: 40px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">
                  Update Soal
                </button><br><br>
              </form>
            </div>
