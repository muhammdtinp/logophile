...
<body class="hold-transition sidebar-mini">
  ...
  <div class="content-wrapper">
    ...
    <div class="content" style="padding: 0px 20px 20px 20px;">
      <div class="container-fluid"><label for="nama_guru">Nama Guru:</label><br>
        <select id="nama_guru" name="nama_guru" class="form-control">
          <?php
          // Mengambil data kota dari tabel database yang sudah ada
        ...
        <div class="row">
          <div class="card mb-0" style="border-radius: 25px; padding:15px 15px 15px 15px;">
            <div class="card-body">
              ...
              <input class="form-control" type="text" id="nama_kategori" name="nama_kategori" required><br>
              ...
              <br>
              <button value="Tambah Kategori" name="tambah_kategori" type="submit" class="btn btn-primary" style="background-color: #1D5D9B; color: white; border: none; width: 195px; height: 40px; border-radius: 10px; display: flex; justify-content: center; align-items: center;">
              Tambah Kategori
              </button>
              </form>
            </div>
