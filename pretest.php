  ...
  <div class="content-wrapper">
    ...
    <div class="content" style="padding: 0px 20px 20px 20px;">
      <div class="card mb-0" style="border-radius: 25px; padding:15px 15px 15px 15px;">
        <div class="card-body">
          <h4 style="color: #1D5D9B; padding-bottom:10px;">Soal Pretest</h4>
          <div class="container-fluid">
            <div class="row">
            <?php
              $no = 0;
              $data = mysqli_query($conn, "SELECT * FROM kategori_kuis INNER JOIN guru ON kategori_kuis.id_guru = guru.id_guru WHERE kategori_kuis.nama_kategori = 'Pre Test'");
            ...
            <div class="card card-success" style="background-color: #CAF4FF; border-radius: 25px;">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card-body" style="padding: 0px;">
                        <h5 class="card-title font-weight-bold" style="color:#1D5D9B">Mengenai Pretest</h5>
              ...
              <div class="card card-success" style="background-color: #CAF4FF; border-radius: 25px;">
                <div class="card-body">
                  ...
                  <?php else: ?>
                  <a href="kuis.php?id=<?php echo $row['id_kategori']?> " class="btn btn-primary"style="background-color: #1D5D9B; color: white; border: none; width: 100%; height: 40px; border-radius: 10px;">Tekan untuk akses soal Pretest</a>
                  <?php endif; ?>
                  <?php
                      }
                  ?>
