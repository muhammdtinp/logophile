  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
            <h1 class="m-0">Pengumpulan LKPD</h1>
        </div>
      </div>
    </div>
    <!-- /.content-header -->
      ...
      <div class="card mb-0" style="border-radius: 25px; padding:15px 15px 15px 15px;">
        <div class="card-body">
          <div class="container-fluid">
            <div class="row">
              <div class="mb-3">
                <form action="upload-laporan.php" method="post" enctype="multipart/form-data">
                  <label for="kelompok" class="form-label"> Nama Kelompok </label>
                  <input type="text" class="form-control" id="kelompok" name="nama_kelompok" placeholder="Nama Kelompok" style="border: 1px solid black; border-radius: 10px;">
              </div>
              <div class="mb-3">
                <label for="anggota" class="form-label"> Anggota Kelompok </label>
                <textarea class="form-control" id="anggota" name="anggota" rows="5" style="border: 1px solid black; border-radius: 10px;"></textarea>
              </div>
              <div class="mb-3">
                <label for="tema" class="form-label"> Tema Diskusi </label>
                <input type="text" class="form-control" id="tema" name="tema" placeholder="Tema Diskusi" style="border: 1px solid black; border-radius: 10px;">
              </div>
              <div class="mb-3">
                <label for="hasil" class="form-label"> Hasil Diskusi </label>
                <textarea class="form-control" id="hasil" name="hasil" rows="5" style="border: 1px solid black; border-radius: 10px;"></textarea>
              </div>
              <div class="form-group">
                <label for="input">File Laporan</label>
                <div class="input-group">
                  <div class="custom-file">
                    <input type="file" name="berkas" accept="application/pdf" style="border: 1px solid black; border-radius: 10px;">
                  </div>
                </div>
              </div>
              <input class="btn btn-primary" type="submit" value="Submit" style="background-color: #1D5D9B; color: white; border: none; width: 100%; height: 40px; border-radius: 10px;">
              </form>
            </div>
          </div>
        </div>
