  ...
  <div class="content-wrapper">
    ...
    <div class="content" style="padding: 0px 20px 20px 20px;">
      <div class="card mb-0" style="border-radius: 25px; padding:15px 15px 15px 15px;">
        <div class="card-body">
          <h4 style="color: #1D5D9B; padding-bottom:10px;">Kuis</h4>
          <div class="container-fluid">
            <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <?php
                        ...
                        $data = mysqli_query($conn, "
                            SELECT kategori_kuis.*, guru.*, materi.id_kategori 
                            FROM kategori_kuis 
                            INNER JOIN guru ON kategori_kuis.id_guru = guru.id_guru
                            INNER JOIN materi ON materi.id_kategori = kategori_kuis.id_kategori
                    ...
                    <?php else: ?>
                    <a href="kuis.php?id=<?php echo $row['id_kategori']?> " class="btn btn-primary"style="background-color: #1D5D9B; color: white; border: none; width: 100%; height: 40px; border-radius: 10px;">Tekan untuk akses Kuis</a>
                    <?php endif; ?>
                    <?php
                        }
                    ?>
        ...
        <div class="d-flex justify-content-between" style="padding: 0px 20px 15px 20px;">
            <a href="materi.php?detail=<?php echo $row['id_materi']?>" 
            ...
            <a href="detail-lkpd.php?detail=<?php echo $row['id_materi']?>" 
              class="btn btn-sm btn-outline-primary" 
              style="background-color: #CAF4FF; color: black; border: 1px solid #1D5D9B; width: 195px; height: 40px; border-radius: 10px; display: flex; align-items: center; justify-content: center;">
              Lanjut ke Session 3
            </a>
